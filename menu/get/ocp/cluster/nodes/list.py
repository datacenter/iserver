...
def get_ocp_cluster_nodes_list_command(ctx, cluster_name, output, devel):
    """Get ocp cluster nodes list"""

    # iserver get ocp cluster nodes list
    ...
    try:
        ...
        if not ocp_handler.k8s_handler.is_connected():
            ctx.busy = False
            ctx.my_output.error(
