...
def get_ocp_vm_net_command(
    ...
    """Get ocp virtual machine network interfaces"""

    # iserver get ocp vm net
    ...
    try:
        ...
        info = ocp_handler.get_ocp_vm_net_info(
            namespace,
            vm_name
        )
        ctx.busy = False
        ...
        ocp_handler.print_ocp_vm_net_info(
            info,
