...
@click.option("--vc", "vcenter_name", default='', callback=validations.empty_string_to_none, help="Filter by vcenter_name")
@click.option("--output", "-o", type=click.Choice(['default', 'json'], case_sensitive=False), default='default', show_default=True)
@click.option("--devel", is_flag=True, show_default=True, default=False, help="Developer output")
def get_ocp_vcenter_command(
        ctx,
        cluster_name,
        vcenter_name,
        output,
    ...
    try:
        ...
        ocp_vcenter_handler.print_ocp_clusters_vcenter(
            clusters
        )
