...
def get_ocp_vms_list_command(ctx, cluster_name, output, devel):
    """Get ocp virtual machines list"""

    # iserver get ocp vms list
    ...
    try:
        ...
        vms = ocp_handler.get_ocp_vms_info()
        ctx.busy = False
        ...
        ocp_handler.print_ocp_vms_info(vms)
