...
def get_iwo_disk_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_disks()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get disk')
            raise ErrorExit
        ...
        iwo_handler.print_disks(managed_objects)
