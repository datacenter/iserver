...
def get_iwo_switch_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_switchs()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get switch')
            raise ErrorExit
        ...
        iwo_handler.print_switchs(managed_objects)
