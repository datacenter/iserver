...
def get_iwo_namespace_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_namespaces()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get namespace')
            raise ErrorExit
        ...
        iwo_handler.print_namespaces(managed_objects)
