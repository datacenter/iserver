...
def get_iwo_spec_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_specs()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get spec')
            raise ErrorExit
        ...
        iwo_handler.print_specs(managed_objects)
