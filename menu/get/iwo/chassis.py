...
def get_iwo_chassis_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_chassiss()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get chassis')
            raise ErrorExit
        ...
        iwo_handler.print_chassiss(managed_objects)
