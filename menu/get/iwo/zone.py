...
def get_iwo_zone_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_zones()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get zone')
            raise ErrorExit
        ...
        iwo_handler.print_zones(managed_objects)
