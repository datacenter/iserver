...
def get_iwo_region_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_regions()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get region')
            raise ErrorExit
        ...
        iwo_handler.print_regions(managed_objects)
