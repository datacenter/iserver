...
def get_iwo_network_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_networks()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get network')
            raise ErrorExit
        ...
        iwo_handler.print_networks(managed_objects)
