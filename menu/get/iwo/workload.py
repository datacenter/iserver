...
def get_iwo_workload_command(
    ...
    try:
        ...
        managed_objects = iwo_handler.get_workloads()
        if managed_objects is None:
            ctx.busy = False
            ctx.my_output.error('Failed to get workload')
            raise ErrorExit
        ...
        iwo_handler.print_workloads(managed_objects)
