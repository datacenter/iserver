...
def get_k8s_nmap_command(
    ...
    try:
        ...
        if output == 'mo':
            nmaps = k8s_handlers.get_network_maps(
        ...
        ctx.my_output.json_output(nmaps)

        if 'state' in view:
            k8s_output_handler.print_network_maps(
                nmaps
            )
