...
def get_k8s_vsclass_command(
    ...
    """Get k8s volume snapshot class"""

    # iserver get k8s vsclass
    ...
    try:
        ...
        if output == 'mo':
            volume_snapshot_classes = k8s_handlers.get_volume_snapshot_classes(
        ...
        if 'state' in view:
            k8s_output_handler.print_volume_snapshot_classes(
                volume_snapshot_classes,
                title=True
            )
