...
def get_k8s_promrule_command(
    ...
    """Get k8s prometheus rule"""

    # iserver get k8s promrule
    ...
    try:
        ...
        if output == 'mo':
            prometheus_rules = k8s_handlers.get_prometheus_rules(
        ...
        if 'state' in view:
            k8s_output_handler.print_prometheus_rules(
                prometheus_rules,
                title=True
            )
