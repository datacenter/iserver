...
def get_k8s_crd_command(
    ...
    """Get k8s custom resource definition"""
    ...
    try:
        ...
        if output == 'mo':
            custom_resource_definitions = k8s_handlers.get_custom_resource_definitions(
        ...
        if 'state' in view:
            k8s_output_handler.print_custom_resource_definitions(
                custom_resource_definitions,
                title=True
            )
