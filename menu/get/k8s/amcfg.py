...
def get_k8s_amcfg_command(
    ...
    """Get k8s alert manager config"""

    # iserver get k8s amcfg
    ...
    try:
        ...
        if output == 'mo':
            alert_manager_configs = k8s_handlers.get_alert_manager_configs(
        ...
        ctx.my_output.json_output(alert_manager_configs)

        if 'state' in view:
            k8s_output_handler.print_alert_manager_configs(
                alert_manager_configs,
                title=True
            )
