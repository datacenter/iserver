...
@click.option("--role", default='', callback=validations.empty_string_to_none, help="Filter by role")
@click.option("--subject", default='', callback=validations.empty_string_to_none, help="Filter by subject")
...
def get_k8s_crb_command(
    ...
    try:
        ...
        if output == 'mo':
            crbs = k8s_handlers.get_cluster_role_bindings(
