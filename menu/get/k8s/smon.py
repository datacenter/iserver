...
def get_k8s_smon_command(
    ...
    try:
        ...
        if output == 'mo':
            service_monitors = k8s_handlers.get_service_monitors(
        ...
        ctx.my_output.json_output(service_monitors)
        ...
        if 'state' in view:
            k8s_output_handler.print_service_monitors(service_monitors)
