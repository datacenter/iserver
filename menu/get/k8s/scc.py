...
def get_k8s_scc_command(
    ...
    """Get k8s security context constraints"""
    ...
    try:
        ...
        if output == 'mo':
            sccs = k8s_handlers.get_security_context_constraints(
        ...
        if 'state' in view:
            k8s_output_handler.print_security_context_constraints(
                sccs,
                title=True
            )
