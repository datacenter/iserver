...
def get_k8s_vmipr_command(
    ...
    """Get k8s virtual machine instance preset"""

    # iserver get k8s vmipr
    ...
    try:
        ...
        if output == 'mo':
            virtual_machine_presets = k8s_handlers.get_virtual_machine_presets(
        ...
        if 'state' in view:
            k8s_output_handler.print_virtual_machine_presets(
                virtual_machine_presets,
                title=True
            )
