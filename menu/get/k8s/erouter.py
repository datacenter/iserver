...
def get_k8s_erouter_command(
    ...
    """Get k8s egress router"""

    # iserver get k8s erouter
    ...
    try:
        ...
        if output == 'mo':
            egress_routers = k8s_handlers.get_egress_routers(
        ...
        if 'state' in view:
            k8s_output_handler.print_egress_routers(
                egress_routers,
                title=True
            )
