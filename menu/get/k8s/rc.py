...
def get_k8s_rc_command(
    ...
    """Get k8s replication controller"""
    ...
    try:
        ...
        if output == 'mo':
            replication_controllers = k8s_handlers.get_replication_controllers(
        ...
        if 'state' in view:
            k8s_output_handler.print_replication_controllers(
                replication_controllers,
                title=True
            )
