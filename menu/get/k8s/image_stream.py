...
def get_k8s_is_command(
    ...
    try:
        ...
        if output == 'mo':
            streams = k8s_handlers.get_image_streams(
        ...
        ctx.my_output.json_output(streams)
        ...
        k8s_output_handler.print_image_streams(
            streams
        )
