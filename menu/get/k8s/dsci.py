...
def get_k8s_dsci_command(
    ...
    """Get k8s data science cluster initialization (ocp)"""
    ...
    try:
        ...
        if output == 'mo':
            clusters = k8s_handlers.get_data_science_cluster_initializations(
        ...
        k8s_output_handler.print_data_science_cluster_initializations(
            clusters
        )
