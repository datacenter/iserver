...
def get_k8s_tgspn_command(
    ...
    try:
        ...
        if output == 'mo':
            sandbox_policies_namespaced = k8s_handlers.get_sandbox_policies_namespaced(
        ...
        ctx.my_output.json_output(sandbox_policies_namespaced)

        if 'state' in view:
            k8s_output_handler.print_sandbox_policies_namespaced(
                sandbox_policies_namespaced,
                title=True
            )
