...
def get_k8s_smap_command(
    ...
    try:
        ...
        if output == 'mo':
            smaps = k8s_handlers.get_storage_maps(
        ...
        ctx.my_output.json_output(smaps)

        if 'state' in view:
            k8s_output_handler.print_storage_maps(
                smaps
            )
