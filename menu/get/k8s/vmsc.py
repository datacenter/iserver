...
def get_k8s_vmsc_command(
    ...
    """Get k8s virtual machine snapshot content"""

    # iserver get k8s vmsc
    ...
    try:
        ...
        if output == 'mo':
            virtual_machine_snapshot_contents = k8s_handlers.get_virtual_machine_snapshot_contents(
