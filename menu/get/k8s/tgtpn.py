...
def get_k8s_tgtpn_command(
    ...
    try:
        ...
        if output == 'mo':
            tracing_policies_namespaced = k8s_handlers.get_tracing_policies_namespaced(
        ...
        ctx.my_output.json_output(tracing_policies_namespaced)

        if 'state' in view:
            k8s_output_handler.print_tracing_policies_namespaced(
                tracing_policies_namespaced,
                title=True
            )
