...
@click.option("--output", "-o", type=click.Choice(['default', 'verbose', 'json'], case_sensitive=False), default='default', show_default=True)
...
def get_aci_node_intf_tun_command(
    ...
    try:
        ...
        if output == 'default':
            aci_output_handler.print_interfaces_tunnel(
                interfaces
            )
