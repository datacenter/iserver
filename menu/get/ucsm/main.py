...
from menu.get.ucsm.fis import get_ucsm_fis_command
from menu.get.ucsm.manager import get_ucsm_manager_command
from menu.get.ucsm.racks import get_ucsm_racks_command
...
get_ucsm_menu.add_command(get_ucsm_fis_command)
get_ucsm_menu.add_command(get_ucsm_manager_command)
get_ucsm_menu.add_command(get_ucsm_racks_command)
