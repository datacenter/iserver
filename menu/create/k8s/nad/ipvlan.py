...
from lib.workflow.k8s import nad_ipvlan_create as workflow
...
@click.option("--mode", type=click.Choice(['l2', 'l3', 'l3s'], case_sensitive=False), default='l2', show_default=True, help="IPVLAN mode")
...
def create_k8s_nad_ipvlan_command(
        ctx,
        cluster_name,
        namespace,
        name,
