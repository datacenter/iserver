...
from lib.workflow.k8s import nad_macvlan_create as workflow
...
@click.option("--mode", type=click.Choice(['bridge', 'passthru', 'private', 'vepa'], case_sensitive=False), default='bridge', show_default=True, help="MacVLAN mode")
...
def create_k8s_nad_macvlan_command(
        ctx,
        cluster_name,
        namespace,
        name,
