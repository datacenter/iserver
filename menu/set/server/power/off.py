...
def set_server_power_off_command(ctx, iaccount, group, serial_filter, name_filter, ip_filter, no_confirm, no_wait, dry_run, verbose, devel):
    """Power off"""

    # iserver set server power off
    ...
    try:
        ...
        if not lcm_server_power_handler.power_off(servers):
            raise ErrorExit
