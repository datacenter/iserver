...
def set_server_power_on_command(ctx, iaccount, group, serial_filter, name_filter, ip_filter, no_confirm, no_wait, dry_run, verbose, devel):
    """Power on"""

    # iserver set server power on
    ...
    try:
        ...
        if not lcm_server_power_handler.power_on(servers):
            raise ErrorExit
