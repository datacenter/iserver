...
def set_server_power_shut_command(ctx, iaccount, group, serial_filter, name_filter, ip_filter, no_confirm, dry_run, verbose, no_wait, devel):
    """Operating system shutdown"""

    # iserver set server power shut
