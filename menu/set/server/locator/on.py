...
def set_server_locator_on_command(ctx, iaccount, group, serial_filter, name_filter, ip_filter, no_confirm, no_wait, dry_run, verbose, devel):
    """Locator on"""
    ...
    try:
        ...
        if not lcm_server_locator_handler.locator_on(servers):
            raise ErrorExit
