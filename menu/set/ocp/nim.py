...
from lib.workflow.ocp_nim_operator import operator_create as ocp_installer
...
def set_ocp_nim_command(ctx, cluster_name, channel, mode, no_confirm):
    """Set nim operator in openshift cluster"""
