...
def set_ocp_tools(
    ...
    """Set ocp cluster tools"""

    # iserver set ocp tools
    ...
    try:
        ...
        cluster_settings['tools'] = {}
        cluster_settings['tools']['ip'] = linux_ip
        cluster_settings['tools']['username'] = username
        cluster_settings['tools']['password'] = password
        cluster_settings['tools']['key_filename'] = key
        ...
        ctx.my_output.default('OCP cluster tools set: %s' % (cluster_name))
