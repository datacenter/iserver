...
from lib.workflow.ocp_serverless_operator import operator_create as ocp_installer
...
def set_ocp_serverless_command(ctx, cluster_name, channel, mode, no_confirm):
    """Set serverless operator in openshift cluster"""
