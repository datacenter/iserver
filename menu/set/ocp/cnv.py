...
from lib.workflow.ocp_cnv_operator import operator_create
from lib.workflow.ocp_cnv_operator import instance_create
from lib.workflow.ocp_cnv_operator import import_enable
...
@click.option("--filename", default='', callback=validations.validate_k8s_yaml_file_optional, show_default=True, help="HyperConverged CRD")
...
def set_ocp_cnv_command(ctx, cluster_name, channel, filename, mode, no_confirm):
    """Set cnv operator in openshift cluster"""
