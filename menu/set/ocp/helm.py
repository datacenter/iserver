...
def set_ocp_helm(
    ...
    try:
        ...
        cluster_settings['helm'] = {}
        cluster_settings['helm']['ip'] = linux_ip
        cluster_settings['helm']['username'] = username
        cluster_settings['helm']['password'] = password
        cluster_settings['helm']['key_filename'] = key
        ...
        ctx.my_output.default('OCP cluster helm set: %s' % (cluster_name))
