...
from lib.workflow.ocp_task import create as task_handler
...
@click.option("--filename", default='', callback=validations.validate_file_absolute, help="Tasks filename")
...
def set_ocp_task_command(
    ...
    try:
        ...
        k8s_handler = validations.validate_kubernetes_name(ctx, cluster_name, cluster_type='ocp', log_id=ctx.run_id)
