...
from lib.workflow.ocp_service_mesh_operator import operator_create as ocp_installer
...
def set_ocp_service_mesh_command(ctx, cluster_name, channel, mode, no_confirm):
    """Set service mesh operator in openshift cluster"""
