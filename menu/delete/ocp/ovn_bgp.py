...
from lib.workflow.ocp_ovn_bgp import wipe
...
@click.option("--mode", type=click.Choice(['feature', 'ra', 'all', 'config', 'ra-config', 'wipe', 'nuke'], case_sensitive=False), default='', show_default=True, help="Mode of operation")
