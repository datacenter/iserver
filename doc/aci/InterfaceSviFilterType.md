...
```
# iserver get aci intf svi --apic apic21 --node cl2208-eu-spdc --type int

Apic: apic21 (mode:online, cache:off)
Pod: 1
Node: cl2208-eu-spdc

Interface SVI State [#14]
-------------------------
...
```
# iserver get aci intf svi --apic apic21 --node cl2208-eu-spdc --type ext
