...
True	294	13	apic11o.emea-sp.cisco.com:443 mo topology/pod-1/node-205/sys/lldp/inst query query-target=subtree&target-subtree-class=lldpAdjEp&rsp-subtree-include=health,fault-count
True	293	0	apic11o.emea-sp.cisco.com:443 mo topology/pod-1/node-205/sys/lldp/inst query rsp-subtree-include=faults,no-scoped,subtree
True	347	0	apic11o.emea-sp.cisco.com:443 mo topology/pod-1/node-205/sys/lldp/inst query rsp-subtree-include=fault-records,no-scoped,subtree&order-by=faultRecord.created|desc&page=0&page-size=1000
True	739	1000	apic11o.emea-sp.cisco.com:443 mo topology/pod-1/node-205/sys/lldp/inst query rsp-subtree-include=event-logs,no-scoped,subtree&order-by=eventRecord.created|desc&page=0&page-size=1000
```
