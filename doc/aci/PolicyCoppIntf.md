...
```
# iserver get aci policy copp --apic apic11 --name default --view intf
...
+-------------+----+-----------+---------------------+-----------+
| default     |    | 0         | pod-1/cl201-eu-spdc | eth1/1    | 
...
True	351	1	apic11o.emea-sp.cisco.com class coppIfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	338	0	apic11o.emea-sp.cisco.com class coppProtoClassP
True	400	464	apic11o.emea-sp.cisco.com class l1RsCoppIfPolCons
