...
```
# iserver get aci policy synce --apic apic11 --name default --view verbose
...
- Sync Status Msg : yes
- Wait-To-Restore : 5
- Rx Qual Min     : fsync-ql-common-none
- Rx Qual Eq      : fsync-ql-common-none
- Rx Qual Max     : fsync-ql-common-none
- Tx Qual Min     : fsync-ql-common-none
- Tx Qual Eq      : fsync-ql-common-none
- Tx Qual Max     : fsync-ql-common-none
...
True	338	1	apic11o.emea-sp.cisco.com class synceEthIfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	398	470	apic11o.emea-sp.cisco.com class l1RsSynceEthIfPolCons
