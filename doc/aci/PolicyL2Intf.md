...
```
# iserver get aci policy l2 --apic apic11 --name default --view intf
...
+-------------+---------------------+-----------+
| default     | pod-1/cl201-eu-spdc | eth1/100  | 
...
True	308	6	apic11o.emea-sp.cisco.com class l2IfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	394	414	apic11o.emea-sp.cisco.com class l1RsL2IfPolCons
