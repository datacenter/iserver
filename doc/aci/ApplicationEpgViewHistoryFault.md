...
```
# iserver get aci epg --apic apic21 --when 60d --name vk8s_1 --view hfault
...
True	6291	3464	apic21o.emea-sp.cisco.com:443 class fvAEPg query rsp-subtree-include=fault-records,no-scoped,subtree&order-by=faultRecord.created|desc&page=0&page-size=1000
```
