...
```
# iserver get aci policy fc --apic apic11 --name default --view usage
...
True	348	1	apic11o.emea-sp.cisco.com class fcIfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	480	408	apic11o.emea-sp.cisco.com class l1RsFcIfPolCons
