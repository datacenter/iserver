...
```
# iserver get aci policy mcp --apic apic11 --name default --view intf
...
+-------------+----+-------------+---------------------+-----------+
| default     |    | enabled     | pod-1/cl201-eu-spdc | eth1/1    | 
...
True	1464	3	apic11o.emea-sp.cisco.com class mcpIfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	372	470	apic11o.emea-sp.cisco.com class l1RsMcpIfPolCons
