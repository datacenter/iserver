...
```
# iserver get aci policy flap --apic apic11 --name default --view intf
...
True	333	1	apic11o.emea-sp.cisco.com class fabricLinkFlapPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	404	464	apic11o.emea-sp.cisco.com class l1RsLinkFlapPolCons
