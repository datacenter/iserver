...
```
# iserver get aci intf svi --apic apic11 --node bl205-eu-spdc --type int
...
```
# iserver get aci intf svi --apic apic11 --node bl205-eu-spdc --type ext
...
True	395	38	apic11o.emea-sp.cisco.com class topology/pod-1/node-205/l2BD query rsp-subtree=full&rsp-subtree-class=sviIf&rsp-subtree-include=required
True	279	61	apic11o.emea-sp.cisco.com class topology/pod-1/node-205/ipv4Addr
```
