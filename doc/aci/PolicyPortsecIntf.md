...
```
# iserver get aci policy portsec --apic apic11 --name default --view intf
...
True	325	1	apic11o.emea-sp.cisco.com class l2PortSecurityPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	420	414	apic11o.emea-sp.cisco.com class l1RsL2PortSecurityCons
