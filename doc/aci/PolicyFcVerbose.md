...
```
# iserver get aci policy fc --apic apic11 --name default --view verbose
...
- TF                    : False
- Port Mode             : f
- Trunk Mode            : trunk-off
- Speed                 : auto
- Fill Pattern          : IDLE
- Receive Buffer Credit : 64
- Interfaces            : 464
- Ref Policies          : 83
...
True	340	1	apic11o.emea-sp.cisco.com class fcIfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	393	464	apic11o.emea-sp.cisco.com class l1RsFcIfPolCons
