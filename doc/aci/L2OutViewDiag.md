...
```
# iserver get aci l2out --apic apic21 --when any --view diag
...
True	334	2	apic21o.emea-sp.cisco.com:443 class l2extRsPathL2OutAtt
True	348	3	apic21o.emea-sp.cisco.com:443 class l2extOut query rsp-subtree-include=faults,no-scoped,subtree
True	451	27	apic21o.emea-sp.cisco.com:443 class l2extOut query rsp-subtree-include=fault-records,no-scoped,subtree&order-by=faultRecord.created|desc&page=0&page-size=1000
True	477	4	apic21o.emea-sp.cisco.com:443 class l2extOut query rsp-subtree-include=event-logs,no-scoped,subtree&order-by=eventRecord.created|desc&page=0&page-size=1000
True	404	9	apic21o.emea-sp.cisco.com:443 class l2extOut query rsp-subtree-include=audit-logs,no-scoped,subtree&order-by=aaaModLR.created|desc&page=0&page-size=1000
```
