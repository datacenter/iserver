...
```
# iserver get aci domain vmm --apic apic21 --name *cdc* --when any --view hfault
...
True	499	-	connect apic21o.emea-sp.cisco.com:443
...
True	2607	3000	apic21o.emea-sp.cisco.com:443 class vmmDomP query rsp-subtree-include=fault-records,no-scoped,subtree&order-by=faultRecord.created|desc&page=0&page-size=1000
```
