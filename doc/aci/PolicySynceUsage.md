...
```
# iserver get aci policy synce --apic apic11 --name default --view usage
...
True	320	1	apic11o.emea-sp.cisco.com class synceEthIfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
