...
```
# iserver get aci policy drain --apic apic11 --name default --view intf
...
True	329	1	apic11o.emea-sp.cisco.com class qosSdIfPol query rsp-subtree=children&rsp-subtree-class=relnFrom
True	409	344	apic11o.emea-sp.cisco.com class l1RsQosSdIfPolCons
