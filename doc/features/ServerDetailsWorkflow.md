# Server Details - Workflow

```
# iserver get server --name comp-1-p2b-eu-spdc-WZP23400AJW --workflow
...
+--------------------------+------------------+--------------------------+-----------+----------+
| Workflow Moid            | Name             | Create Time              | Status    | Duration |
+--------------------------+------------------+--------------------------+-----------+----------+
| 63b5c955696f6e2d30bd0bfb | Turn Off Locator | 2023-01-04T18:45:41.509Z | COMPLETED | 00:00:04 | 
| 63b5c923696f6e2d30bd0b5d | Turn On Locator  | 2023-01-04T18:44:51.803Z | COMPLETED | 00:00:05 | 
+--------------------------+------------------+--------------------------+-----------+----------+
```
...
2023-01-05 18:53:03.940713	True	3198	93	isctl get compute rackunit   -o json --top 100
2023-01-05 18:53:05.644704	True	1699	10	isctl get compute blade   -o json --top 100
2023-01-05 18:53:10.644982	True	1573	1	isctl get equipment locatorled --filter "RegisteredDevice/Moid eq '5fdf9be76f72612d300a8d81'"  -o json --top 100
2023-01-05 18:53:12.092039	True	1443	1	isctl get asset deviceregistration  moid 5fdf9be76f72612d300a8d81 -o json
2023-01-05 18:53:13.875244	True	1779	3	isctl get workflow workflowinfo --filter "CreateTime gt 2022-12-29T18:53:12.000Z"  -o json --top 100
```
