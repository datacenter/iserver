...
```{
    ...
    "Members": [
        ...
        {
            "@odata.id": "/redfish/v1/UpdateService/FirmwareInventory/slot-3"
        },
        {
            "@odata.id": "/redfish/v1/UpdateService/FirmwareInventory/slot-5"
        },
        {
...
```{
    ...
    "Name": "BIOS",
    "Updateable": true,
    "Version": "C240M4.4.1.2c.0.0202211902"
}
```
...
## /redfish/v1/UpdateService/FirmwareInventory/slot-3
...
## /redfish/v1/UpdateService/FirmwareInventory/slot-5
