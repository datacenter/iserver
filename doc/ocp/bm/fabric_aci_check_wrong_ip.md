# Fabric checks with IP mismatch
...
- Interface found
        ...
        - my_tenant/my_anp/some_epg
                pod-1:node-100:eth1/2/1 (my_pg)
                pod-1:node-200:eth1/2/1 (my_pg)
[ERROR] IP Endpoint with EPG mismatch [my_tenant/my_anp/my_epg]
...
- Interface found
        ...
        Operational Speed 10G
        IP endpoint [10.4.4.1] found
        - my_tenant/my_anp/bmmy_tenant_prov
                pod-1:node-100:eth1/2/1 (my_pg)
                pod-1:node-200:eth1/2/1 (my_pg)
[ERROR] IP Endpoint with EPG mismatch [my_tenant/my_anp/my_epg]
[ERROR] IP endpoint found on different interfaces
