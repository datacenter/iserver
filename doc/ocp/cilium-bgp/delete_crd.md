# Cilium BGP Control Plane - Delete CRDs
...
```
# iserver delete ocp cilium bgp --mode crd
...
OpenShift Workflow - Cilium BGP Control Plane - Delete configuration
====================================================================
...
~~~
Continue [Y/N]? y
IsovalentBGPClusterConfig aci deleted
IsovalentBGPPeerConfig aci deleted
IsovalentBGPAdvertisement aci deleted
```
