# Local Storage Operator - Create Volume in discover-all mode
...
### Expected outcome example for 3-node cluster
...
| 5  | local-pv-bfe2de2d | Available | Block | local-sc | 1117Gi | RWO    | --  | 1h0m | 
| 6  | local-pv-d27c3b90 | Available | Block | local-sc | 1117Gi | RWO    | --  | 1h0m | 
+----+-------------------+-----------+-------+----------+--------+--------+-----+------+
