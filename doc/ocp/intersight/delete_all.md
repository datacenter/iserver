# Cisco Intersight Plugin - Delete everything

[[Back]](./README.md) [[Next]](./delete_task.md) [[create-all]](./create_all.md)

## Workflow sequence

- [disable plugin](./disable_plugin.md)
...
```
# iserver delete ocp intersight --cluster bm1 --mode all --no-confirm
