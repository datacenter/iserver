...
NodeNetworkConfigurationPolicy (NNCP) is [nmstate](../nmstate/README.md) crd exposing control of network configuration for
...
iserver set ocp task | in task-way
