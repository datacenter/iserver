# Intersight OpenTelemtry Metrics into Prometheus
...
data:
  intersight-otel.toml: |
    ...
    [[pollers]]
    name = "intersight.tam.advisory.count"
    otel_attributes = { node = "bm1-1" }
    api_query = "api/v1/tam/AdvisoryInstances?$filter=AffectedObjectMoid eq '5fdf9c016176752d35e44795'"
    aggregator = "count_results"
    interval = 60

    [[pollers]]
    name = "intersight.tam.advisory.count"
    otel_attributes = { node = "bm1-2" }
    api_query = "api/v1/tam/AdvisoryInstances?$filter=AffectedObjectMoid eq '5fdf9c786176752d35e47110'"
    aggregator = "count_results"
    interval = 60

    [[pollers]]
    name = "intersight.tam.advisory.count"
    otel_attributes = { node = "bm1-3" }
    api_query = "api/v1/tam/AdvisoryInstances?$filter=AffectedObjectMoid eq '5fdf9d026176752d35e4ac4e'"
    aggregator = "count_results"
    interval = 60

    [[pollers]]
    name = "intersight.tam.advisory.count"
    otel_attributes = { cluster = "bm1" }
    api_query = "api/v1/tam/AdvisoryInstances?$filter=AffectedObjectMoid in ('5fdf9c016176752d35e44795', '5fdf9c786176752d35e47110', '5fdf9d026176752d35e
4ac4e')"
    aggregator = "count_results"
    interval = 60
