...
iserver set ocp iotel | deploy intersight-otel instance | [Link](./create_instance.md)
iserver set ocp iotel | in task way | [Link](./create_task.md)
iserver delete ocp iotel | delete intersight-otel instance | [Link](./delete_instance.md)
