...
from lib.webex_bot.models.command import Command, COMMAND_KEYWORD_KEY
from lib.webex_bot.models.response import response_from_adaptive_card
...
class HelpCommand(Command):
    ...
    def build_card(self, message, attachment_actions, activity):
        ...
        log.info('build help card activity: %s', activity)
