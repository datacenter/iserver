...
class K8sClusterRoleBindingInfo():
    ...
    def get_cluster_role_binding_info(self, managed_object):
    ...
    def get_cluster_role_binding(self, name, return_mo=False, cache_enabled=True, optimized=True):
    ...
    def is_cluster_role_binding(self, name, return_mo=False, cache_enabled=True, optimized=True):
        if self.get_cluster_role_binding(name, return_mo=return_mo, cache_enabled=cache_enabled, optimized=optimized) is None:
            return False
        return True
