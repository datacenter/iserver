...
class K8sRouteIntersight():
    def __init__(self):
        pass

    def get_intersight_route(self, namespace='cisco-intersight', name='cisco-intersight-api', cache_enabled=True):
        return self.get_route(namespace, name, cache_enabled=cache_enabled)

    def create_intersight_route(self, namespace='cisco-intersight', name='cisco-intersight-api', confirmation=False, my_output=None, wait=True):
        if my_output is not None:
            my_output.default('Create cisco intersight operator api route', before_newline=True, underline=True)
        ...
        body['spec']['port'] = {}
        body['spec']['port']['targetPort'] = 'tcp/9443'
        body['spec']['to'] = {}
    ...
    def delete_intersight_route(self, namespace='cisco-intersight', name='cisco-intersight-api', my_output=None):
        if my_output is not None:
            my_output.default('Delete cisco intersight operator api route', before_newline=True, underline=True)
