...
class K8sNetworkAttachmentDefinitionIpVlan():
    def __init__(self):
        pass

    def get_nad_ipvlan_body(self, namespace, name, master, mode, ipam, address, gateway):
        body = {}
