...
class RedfishEndpointUcsRackTemplateStorage():
    ...
    def print_template_storage_controller_properties(self, info, title=False):
        if title:
    ...
    def print_template_storage_drive_properties(self, info, title=False):
        if title:
            self.my_output.default(
    ...
    def print_template_storage_volume_properties(self, info, title=False):
        if title:
            self.my_output.default(
    ...
    def print_template_storage_properties(self, properties):
        self.print_template_storage_controller_properties(
            properties['Controller'],
            title=True
        )

        self.print_template_storage_drive_properties(
            properties['Drive'],
            title=True
        )

        self.print_template_storage_volume_properties(
            properties['Volume'],
            title=True
        )
