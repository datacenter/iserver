...
from lib.aci.domain.l3.create import DomainL3Create
from lib.aci.domain.l3.delete import DomainL3Delete
from lib.aci.domain.l3.update import DomainL3Update
...
class DomainL3(
    ...
    def __init__(self):
        ...
        DomainL3Create.__init__(self)
        DomainL3Delete.__init__(self)
        DomainL3Update.__init__(self)
