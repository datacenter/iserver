...
class EpgIfConnInfo():
    ...
    def get_epg_ifconn_targetdn_info(self, target_dn):
        ...
        if target_dn.split('/')[2].startswith('node-') and target_dn.split('/')[3] == 'sys':
            # "targetDn": "topology/pod-1/node-2205/sys/lsnode-10.58.24.17"
    ...
    def get_epg_ifconn_info(self, managed_object):
        ...
        # "classPref": "encap",
        # "descr": "",
        # "dn": "uni/epp/fv-[uni/tn-k8s/ap-k8s_ANP/epg-vk8s_4]/node-2207/dyatt-[topology/pod-1/protpaths-2207-2208/pathep-[k8s_esx72_PolGrp]]/conndef/conn-[vlan-1368]-[0.0.0.0]",
        # "encap": "vlan-1368",
        # "extEncap": "unknown",
        # "gw": "0.0.0.0",
        # "ifInstT": "l3-port",
