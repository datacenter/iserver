class PolicyInterfaceLinkFlapContext():
    def __init__(self):
        pass

    def set_policy_interface_link_flap_context(self, policies):
        ...
        for policy in policies:
            for interface_info in policy['l1RsLinkFlapPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_link_flap_context',
                'Context set failed'
            )
