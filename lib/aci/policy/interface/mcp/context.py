class PolicyInterfaceMcpContext():
    def __init__(self):
        pass

    def set_policy_interface_mcp_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "mcpIfPol",
        # "policyDn": "uni/infra/mcpIfP-k8s_mcp_enable",
        # "policyName": "k8s_mcp_enable"
        #
        # Context
        # "mcp": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsMcpIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_mcp_context',
                'Context set failed'
            )
