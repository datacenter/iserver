class PolicyInterfaceLldpContext():
    def __init__(self):
        pass

    def set_policy_interface_lldp_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyDn": "uni/infra/lldpIfP-k8s_lldp_enable",
        # "policyName": "k8s_lldp_enable"
        #
        # Context
        # "lldp": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsLldpIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_lldp_context',
                'Context set failed'
            )
