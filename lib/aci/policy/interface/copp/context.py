class PolicyInterfaceCoppContext():
    def __init__(self):
        pass

    def set_policy_interface_copp_context(self, policies):
        ...
        for policy in policies:
            for interface_info in policy['l1RsCoppIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_copp_context',
                'Context set failed'
            )
