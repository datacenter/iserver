class PolicyInterfaceTransceiverContext():
    def __init__(self):
        pass

    def set_policy_interface_transceiver_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "transceiverIfPol",
        # "policyDn": "uni/infra/transceiverIfP-k8s_transceiver_enable",
        # "policyName": "k8s_transceiver_enable"
        #
        # Context
        # "transceiver": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsSynceEthIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_transceiver_context',
                'Context set failed'
            )
