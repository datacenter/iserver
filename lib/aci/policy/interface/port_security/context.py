class PolicyInterfacePortSecurityContext():
    def __init__(self):
        pass

    def set_policy_interface_port_security_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyDn": "uni/infra/port_securityIfP-k8s_port_security_enable",
        # "policyName": "k8s_port_security_enable"
        #
        # Context
        # "port_security": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsL2PortSecurityCons']:
        ...
        success = self.context_handler.set(
            'pol-port_security-phy',
            intf_context
        )
        if not success:
            self.log.error(
                'set_policy_interface_port_security_context',
                'Context set failed'
            )
