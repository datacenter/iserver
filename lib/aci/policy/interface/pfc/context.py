class PolicyInterfacePfcContext():
    def __init__(self):
        pass

    def set_policy_interface_pfc_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "qosPfcIfPol",
        # "policyDn": "uni/infra/pfcIfP-k8s_pfc_enable",
        # "policyName": "k8s_pfc_enable"
        #
        # Context
        # "pfc": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsQosPfcIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_pfc_context',
                'Context set failed'
            )
