class PolicyInterfaceStpContext():
    def __init__(self):
        pass

    def set_policy_interface_stp_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "stpIfPol",
        # "policyDn": "uni/infra/stpIfP-k8s_stp_enable",
        # "policyName": "k8s_stp_enable"
        #
        # Context
        # "stp": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsStpIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_stp_context',
                'Context set failed'
            )
