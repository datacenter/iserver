class PolicyInterfaceStormControlContext():
    def __init__(self):
        pass

    def set_policy_interface_storm_control_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "stormctrlIfPol",
        # "policyDn": "uni/infra/storm_controlIfP-k8s_storm_control_enable",
        # "policyName": "k8s_storm_control_enable"
        #
        # Context
        # "storm_control": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsStormctrlIfPolCons']:
        ...
        success = self.context_handler.set(
            'pol-storm_control-phy',
            intf_context
        )
        if not success:
            self.log.error(
                'set_policy_interface_storm_control_context',
                'Context set failed'
            )
