class PolicyInterfaceCdpContext():
    def __init__(self):
        pass

    def set_policy_interface_cdp_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "cdpIfPol",
        # "policyDn": "uni/infra/cdpIfP-k8s_cdp_enable",
        # "policyName": "k8s_cdp_enable"
        #
        # Context
        # "cdp": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsCdpIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_cdp_context',
                'Context set failed'
            )
