class PolicyInterfaceL2Context():
    def __init__(self):
        pass

    def set_policy_interface_l2_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "l2IfPol",
        # "policyDn": "uni/infra/l2IfP-k8s_l2_enable",
        # "policyName": "k8s_l2_enable"
        #
        # Context
        # "l2": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsL2IfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_l2_context',
                'Context set failed'
            )
