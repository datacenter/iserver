class PolicyInterfaceAuthContext():
    def __init__(self):
        pass

    def set_policy_interface_auth_context(self, policies):
        ...
        for policy in policies:
            for interface_info in policy['l1RsL2PortAuthCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_auth_context',
                'Context set failed'
            )
