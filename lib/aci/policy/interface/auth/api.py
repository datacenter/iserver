class PolicyInterfaceAuthApi():
    def __init__(self):
        self.policy_interface_auth_mo = None

    def get_policy_interface_auth_mo(self):
        ...
        for managed_object in managed_objects['imdata']:
            attributes = managed_object['l2PortAuthPol']['attributes']
            attributes['relnFrom'] = self.get_policy_interface_reln(
                managed_object,
                'l2PortAuthPol'
            )

            self.policy_interface_auth_mo.append(
                attributes
            )
