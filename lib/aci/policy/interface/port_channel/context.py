class PolicyInterfacePortChannelContext():
    def __init__(self):
        pass

    def set_policy_interface_port_channel_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "port_channelIfPol",
        # "policyDn": "uni/infra/port_channelIfP-k8s_port_channel_enable",
        # "policyName": "k8s_port_channel_enable"
        #
        # Context
        # "port_channel": {
        #     "apic": [
        ...
        success = self.context_handler.set(
            'pol-port_channel-phy',
            intf_context
        )
        if not success:
            self.log.error(
                'set_policy_interface_port_channel_context',
                'Context set failed'
            )
