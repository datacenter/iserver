class PolicyInterfaceFcContext():
    def __init__(self):
        pass

    def set_policy_interface_fc_context(self, policies):
        # Interface
        # "podId": "1",
        # "nodeId": "2207",
        ...
        # "policyType": "fcIfPol",
        # "policyDn": "uni/infra/fcIfP-k8s_fc_enable",
        # "policyName": "k8s_fc_enable"
        #
        # Context
        # "phy": {
        #     "apic": [
        ...
        for policy in policies:
            for interface_info in policy['l1RsFcIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_fc_context',
                'Context set failed'
            )
