class PolicyInterfaceDppContext():
    def __init__(self):
        pass

    def set_policy_interface_dpp_context(self, policies):
        ...
        for policy in policies:
            for interface_info in policy['l1RsQosEgressDppIfPolCons']:
        ...
        if not success:
            self.log.error(
                'set_policy_interface_dpp_context',
                'Context set failed'
            )
