class InterfaceTransApi():
    def __init__(self):
        self.interface_trans_mo = None

    def get_interface_trans_mo(self, local_cache_enabled=True, cache_enabled=True):
        command = 'show interface transceiver'

        if local_cache_enabled:
            if self.interface_trans_mo is not None:
                return self.interface_trans_mo
        ...
        self.interface_trans_mo = response
