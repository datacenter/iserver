class PcTrafficApi():
    def __init__(self):
        self.pc_traffic_mo = None

    def get_pc_traffic_mo(self, local_cache_enabled=True, cache_enabled=True):
        command = 'show port-channel traffic'

        if local_cache_enabled:
            if self.pc_traffic_mo is not None:
                return self.pc_traffic_mo
