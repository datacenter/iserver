...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - OpenShift Data Foundation (ODF) Operator - Create Operator', before_newline=True, after_newline=True, double_underline=True)
    ...
    if params['k8s_handler'].is_odf_subscription(params['namespace'], params['name']):
        my_output.default('ODF already created')
        return True
    ...
    success = params['k8s_handler'].create_odf_subscription(
        params['namespace'], 
        params['name'], 
    ...
    my_output.default('- OpenShift Data Foundation (ODF) Operator installed')
