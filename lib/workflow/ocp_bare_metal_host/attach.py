...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Bare Metal Host - Attach', before_newline=True, after_newline=True, double_underline=True)
    ...
    for node in target:
        success = params['k8s_handler'].set_bare_metal_host_attached(
    ...
    my_output.default('- bare metal hosts attached')
