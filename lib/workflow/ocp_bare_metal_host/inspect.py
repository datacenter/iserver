...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Bare Metal Host - Inspection', before_newline=True, after_newline=True, double_underline=True)
    ...
    success = params['k8s_handler'].set_bare_metal_host_inspect(
    ...
    my_output.default('- bare metal host inspection initiatied')
