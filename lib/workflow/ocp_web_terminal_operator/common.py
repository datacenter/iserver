...
def get_default_params():
    params = {}
    params['namespace'] = 'openshift-operators'
    params['name'] = 'web-terminal'
    params['workspace'] = 'devworkspace-operator'
    params['terminal-ns'] = 'openshift-terminal'
    params['operator-group-name'] = None
