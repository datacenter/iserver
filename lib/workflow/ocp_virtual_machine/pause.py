...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Virtual Machine - Pause', before_newline=True, after_newline=True, double_underline=True)
    ...
    for virtual_machine in virtual_machines:
        vm_success = params['k8s_handler'].pause_virtual_machine(
            params['ssh_handler'],
