...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Service Mesh Operator - Create Operator', before_newline=True, after_newline=True, double_underline=True)
    ...
    if subscription is not None:
        my_output.default('Service Mesh Operator already created')
    else:
        ...
        success = params['k8s_handler'].create_service_mesh_subscription(
            params['namespace'], 
            params['name_v2'], 
    ...
    my_output.default('- Service mesh operator installed')
