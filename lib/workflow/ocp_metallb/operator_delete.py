...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - MetalLB Operator - Delete Operator', before_newline=True, after_newline=True, double_underline=True)
    ...
    if subscription is not None:
        success = params['k8s_handler'].delete_metallb_subscription(
    ...
    my_output.default('- MetalLB instances deleted')
