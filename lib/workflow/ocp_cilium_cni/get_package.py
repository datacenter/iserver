...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Cilium - Get cni package', before_newline=True, after_newline=True, double_underline=True)
    ...
    local_common.get_subscription(params, my_output, True)
    return True
