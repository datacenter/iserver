...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - OVNKubernetes - Enable frr-k8s', before_newline=True, after_newline=True, double_underline=True)
    ...
    success = params['k8s_handler'].enable_ovn_frr(
    ...
    my_output.default('- OVN frr-k8s enabled')
