...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - OVNKubernetes - Disable frr-k8s route advertisement', before_newline=True, after_newline=True, double_underline=True)
    ...
    my_output.default('- OVN frr-k8s route advertisement disabled')
