...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - OVNKubernetes - Delete frr configuration', before_newline=True, after_newline=True, double_underline=True)
    ...
    my_output.default('- OVN frr configuration deleted')
