...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Container Virtualization Operator - Enable Data Import Cron', before_newline=True, after_newline=True, double_underline=True)
    ...
    if import_enabled:
        my_output.default('Data import cron already enabled', before_newline=True)
        return True
    
    success = params['k8s_handler'].enable_hyperconverged_boot_image_import(
