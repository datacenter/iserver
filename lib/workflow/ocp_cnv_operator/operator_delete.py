...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Container Virtualization Operator - Delete Operator', before_newline=True, after_newline=True, double_underline=True)
    ...
    if subscription is None:
        ...
        if params['k8s_handler'].is_hyperconverged(cache_enabled=False):
            my_output.error('Delete hypercoverged instance first')
            return False
        
        success = params['k8s_handler'].delete_cnv_subscription(
