...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - VAST CSI Operator - Delete Driver', before_newline=True, after_newline=True, double_underline=True)
    ...
    my_output.default('- VAST CSI driver deleted')
