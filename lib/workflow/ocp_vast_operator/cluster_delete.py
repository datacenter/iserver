...
def validate(params):
    ...
    params['cluster_name'] = params['name']
...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - VAST CSI Operator - Delete Cluster', before_newline=True, after_newline=True, double_underline=True)
    ...
    my_output.default('- VAST CSI cluster deleted')
