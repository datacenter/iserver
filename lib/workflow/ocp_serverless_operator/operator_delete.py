...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - Serverless Operator - Delete Operator', before_newline=True, after_newline=True, double_underline=True)
    ...
    if subscription is None:
        ...
        success = params['k8s_handler'].delete_serverless_subscription(
