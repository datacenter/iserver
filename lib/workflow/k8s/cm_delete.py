...
def run(params, log_id=None):
    ...
    my_output.default('Kubernetes Workflow - Config Map - Delete', before_newline=True, after_newline=True, double_underline=True)
    ...
    my_output.default('- config map deleted')
    return True
