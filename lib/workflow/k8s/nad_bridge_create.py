...
def validate(params):
    rules = [
        ...
        ['bridge', False, None, 'str', None, None, None, None],
        ['default', False, False, 'bool', None, None, None, None],
...
def run(params, log_id=None):
    ...
    my_output.default('Kubernetes Workflow - Network Attachment Definition - Create Bridge', before_newline=True, after_newline=True, double_underline=True)
    ...
    success = params['k8s_handler'].create_nad_bridge(
        params['namespace'], 
        params['name'], 
        params['bridge'],
        params['ipam'],
