...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - LB IP Pool - Delete', before_newline=True, after_newline=True, double_underline=True)
    ...
    success = params['k8s_handler'].delete_cilium_load_balancer_ip_pool(
        params['name'], 
        my_output=my_output, 
        wait=params['wait']
    )
    ...
    my_output.default('- lb ip pool deleted')
    return True
