...
def run(params, log_id=None):
    ...
    my_output.default('OpenShift Workflow - MinIO Operator - Create Operator', before_newline=True, after_newline=True, double_underline=True)
    ...
    if subscription is not None:
        my_output.default('MinIO Operator already created')
    else:
        ...
        success = params['k8s_handler'].create_minio_subscription(
            params['namespace'], 
            params['name'], 
    ...
    my_output.default('- MinIO operator installed')
