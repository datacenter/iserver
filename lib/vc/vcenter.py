...
from lib.vc.lcm_vm import LcmVm
...
class Vcenter(VcCommon, VcConnect, VcDatacenter, VcDatastore, VcHost, VcHelper, LcmVm, VcNetwork, VcVirtualMachine, VcVirtualMachineLcm, VcVmCluster, VcVmFolder):
    def __init__(self, vcenter_ip, vcenter_username, vcenter_password, port=443, disable_ssl_verification=True, verbose=False, debug=False, log_id=None):
        ...
        LcmVm.__init__(self, verbose=verbose, debug=debug)
