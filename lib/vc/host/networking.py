...
class VcHostNetworking():
    ...
    def get_host_networking_hint_cdp_info(self, cdp_obj):
        ...
        #   ttl = 170,
        #   samples = 44366,
        #   devId = 'ipn22-eu-spdc.emea-sp.cisco.com(FDO21192H0X)',
        #   address = '10.58.24.32',
        #   portId = 'Ethernet1/10',
        ...
        #      repeater = false
        #   },
        #   softwareVersion = 'Cisco Nexus Operating System (NX-OS) Software, Version 9.3(9)',
        #   hardwarePlatform = 'N9K-C93180YC-EX',
        #   ipPrefix = '0.0.0.0',
        #   ipPrefixLen = 0,
        #   vlan = 1,
        #   fullDuplex = false,
        #   mtu = 9216,
        #   systemName = 'ipn22-eu-spdc',
        #   systemOID = '1.3.6.1.4.1.9.12.3.1.3.1812',
        #   mgmtAddr = '10.58.234.130',
        #   location = ''
        info = {}
    ...
    def get_host_networking_hint_lldp_info(self, lldp_obj):
        ...
        #         value = (vim.host.PhysicalNic.CdpDeviceCapability) {
        #            dynamicType = <unset>,
        #            dynamicProperty = (vmodl.DynamicProperty) [],
        #            router = true,
        ...
        #         value = 'topology/pod-1/paths-2202/pathep-[eth1/38]'
        #      },
        #      (vmodl.KeyAnyValue) {
        #         dynamicType = <unset>,
        #         dynamicProperty = (vmodl.DynamicProperty) [],
        #         key = 'System Description',
        #         value = 'topology/pod-1/node-2202'
        #      },
        #      (vmodl.KeyAnyValue) {
        #         dynamicType = <unset>,
        #         dynamicProperty = (vmodl.DynamicProperty) [],
        #         key = 'System Name',
        #         value = 'cl2202-eu-spdc.cisco.com'
        #      }
        #   ]
