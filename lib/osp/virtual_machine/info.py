...
class OspVirtualMachineInfo():
    ...
    def get_virtual_machines(self, object_filter=None, flavor_info=False, tenant_info=False, image_info=False, volume_info=False, network_info=False, subnet_info=False, port_info=False, cache_enabled=True):
