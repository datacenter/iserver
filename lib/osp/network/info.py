...
class OspNetworkInfo():
            ...
            if key == 'name':
                ...
                if len(value.split('/')) == 2:
                    ...
                    if 'tenant_name' in network_info:
                        if not filter_helper.match_string(value.split('/')[0], network_info['tenant_name']):
                            return False
    ...
    def get_networks(self, object_filter=None, tenant_info=False, subnet_info=False, port_info=False, cache_enabled=True):
